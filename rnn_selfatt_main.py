...
decoder_num_features = 1 # outputchannel
...
def train():
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        print(print_msg)
        '''
        if mini_val_loss > valid_loss:
            mini_val_loss = valid_loss
            save_path = os.getcwd()
            torch.save(net, save_path + "/trained_model.{:02d}-{:.2f}".format(epoch, valid_loss))
...
def inference():
    ...
    file_path = os.getcwd() + '/checkpoint/trained_model.3994.24'
